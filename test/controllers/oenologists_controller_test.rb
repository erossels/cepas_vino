...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference('Oenologist.count') do
      post oenologists_url, params: { oenologist: { age: @oenologist.age, company: @oenologist.company, name: @oenologist.name, nationality: @oenologist.nationality, role: @oenologist.role } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { age: @oenologist.age, company: @oenologist.company, name: @oenologist.name, nationality: @oenologist.nationality, role: @oenologist.role } }
